...
Route::get('/posts/{post}/edit', [App\Http\Controllers\PostController::class, 'edit'])->name('post.edit'); //{{--Επιτρέπει στον χρηστη να μπορει να διαγράψει μονο τα δικα του Posts  --}}
